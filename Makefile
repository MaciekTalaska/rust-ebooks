...
trplmobi: build trplepub 
	...
	echo $cid
	#cid=$(shell docker ps -alq)
	echo 'last container is: '
	echo $(shell docker ps -alq)
	...
	# docker exec `docker ps -alq` sh -c "ls /trpl-book/src"
